...
STATES = [State(name='IDLE', id=0, devices={'master': DeviceState(values={}, events=[]), 'tablet': DeviceState(values={}, events=[]), 'amib2': DeviceState(values={}, events=[])}), State(name='TEST', id=1, devices={'master': DeviceState(values=OrderedDict(), events=['fastBlink']), 'amib2': DeviceState(values=OrderedDict(), events=['fastBlink']), 'tablet': DeviceState(values={}, events=[])})]
