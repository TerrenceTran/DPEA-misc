...
STATES = [State(name='IDLE', id=0, devices={'master': DeviceState(values={}, events=[]), 'tablet': DeviceState(values={}, events=[])}), State(name='SINGLESTEPPER', id=1, devices={'master': DeviceState(values=OrderedDict([('stepperPosition', 'uint32_t')]), events=['homeStepper']), 'tablet': DeviceState(values={}, events=[])})]
